...
```bash
harbor auth login
harbor publish evals/reliability-is-blind/task --public
harbor publish evals/compute-bazaar-bench --public
```
...
```bash
harbor upload evals/jobs/reliability-is-blind-mistral-matched-20-rib-001 --public
harbor upload evals/jobs/reliability-is-blind-mistral-matched-20-rib-011 --public
harbor upload evals/jobs/reliability-is-blind-mistral-matched-20-rib-016 --public
```
