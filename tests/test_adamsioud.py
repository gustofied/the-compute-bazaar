...
class AdamSioudServerTests(unittest.TestCase):
    def test_clean_article_cards_read_versioned_public_gold_contracts(self) -> None:
        ...
        self.assertIn("compute-api-card__art", article)
        self.assertIn("compute-api-card__fields", article)
        ...
        self.assertIn('src="./compute-cards.js?v=4"', article)
        self.assertIn('href="./compute-card.css?v=10"', article)
        ...
        self.assertIn(".compute-api-card__fields", styles)
