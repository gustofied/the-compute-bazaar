...
class AdamSioudServerTests(unittest.TestCase):
    ...
    def test_clean_article_cards_read_versioned_public_gold_contracts(self) -> None:
        ...
        self.assertIn("product?.publication?.display_line", prime_source)
        ...
        self.assertIn('src="./compute-cards.js?v=21"', article)
        self.assertIn('href="./compute-card.css?v=26"', article)
        ...
        self.assertIn(".prime-shelf-depth-line", styles)
