...
class AdamSioudServerTests(unittest.TestCase):
    ...
    def test_clean_article_cards_read_versioned_public_gold_contracts(self) -> None:
        ...
        self.assertIn("data-index-work", article)
        self.assertEqual(article.count("data-story-work"), 2)
        ...
        self.assertIn('src="./compute-cards.js?v=15"', article)
        self.assertIn('href="./compute-card.css?v=21"', article)
