...
class AdamSioudServerTests(unittest.TestCase):
    ...
    def test_clean_article_cards_read_versioned_public_gold_contracts(self) -> None:
        ...
        prime_source = (article_root / "prime-offer-shelf-card.source.js").read_text(
            encoding="utf-8"
        )
        ...
        self.assertIn('id="prime-offer-shelf-card"', article)
        ...
        self.assertIn("data-prime-shelf-card", article)
        self.assertIn('data-prime-panel="cover"', article)
        self.assertIn('data-prime-panel="detail"', article)
        self.assertIn('data-prime-panel="work"', article)
        self.assertIn('data-prime-panel="share"', article)
        ...
        self.assertIn("product.publication?.states", prime_source)
        self.assertIn("product?.publication?.url", prime_source)
        self.assertNotIn("product?.publication?.display_line", prime_source)
        ...
        self.assertEqual(article.count("data-work-rows"), 4)
        ...
        self.assertEqual(article.count("data-work-endpoint"), 4)
        ...
        self.assertIn('src="./compute-cards.js?v=28"', article)
        self.assertIn('href="./compute-card.css?v=36"', article)
        self.assertIn("family=Geist:wght@400;500;600", article)
        self.assertEqual(article.count("data-card-feed="), 3)
        self.assertEqual(article.count('class="compute-card-prose"'), 4)
        ...
        self.assertEqual(article.count('width="600"'), 7)
        self.assertEqual(article.count('height="600"'), 7)
        for name, digest in {
        ...
        self.assertIn('import * as d3 from "d3"', prime_source)
        ...
        self.assertIn('import { animate } from "motion"', prime_source)
        ...
        self.assertEqual(article.count("data-work-position"), 4)
        ...
        self.assertIn('toggleAttribute("inert"', prime_source)
        self.assertIn("prime-frontier-offer-shelf.json", prime_source)
        self.assertIn("prime-frontier-offer-market.json", prime_source)
        self.assertIn("aggregateTransitions", prime_source)
        self.assertIn("createCardWork", prime_source)
        ...
        self.assertIn("Price and offers", article)
        self.assertNotIn("Advertised reference", article)
        self.assertNotIn("completed rentals", prime_source)
        ...
        self.assertIn('"ESTIMATED JOB COST"', sandbox_source)
        self.assertIn('"MEASURED RUNTIME"', sandbox_source)
        ...
        self.assertIn(".prime-shelf-reference", styles)
        self.assertIn(".prime-shelf-price-area", styles)
        self.assertIn(".prime-shelf-offer-bands", styles)
        self.assertIn(".prime-shelf-benchmark", styles)
        self.assertIn(".prime-shelf-tooltip", styles)
